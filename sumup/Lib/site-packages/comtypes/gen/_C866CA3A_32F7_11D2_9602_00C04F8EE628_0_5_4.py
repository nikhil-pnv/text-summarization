...
__all__ = [
    'SAFT16kHz16BitStereo', 'DISPID_SMSAMMHandle', 'SGRSTTWildcard',
    'SPCATEGORYTYPE', 'SP_VISEME_17', 'SAFT11kHz8BitStereo',
    'SDTPronunciation', 'SSSPTRelativeToStart', 'SRSEDone',
    'eLEXTYPE_PRIVATE9', 'DISPID_SGRSAddWordTransition',
    'DISPID_SRRAlternates', 'SRESoundEnd', 'ISpNotifySource',
    'SpMMAudioIn', 'DISPID_SPRNumberOfElements',
    'DISPIDSPTSI_ActiveOffset', 'IEnumSpObjectTokens',
    'SPPS_RESERVED4', 'ISpNotifyTranslator',
    'DISPID_SRCEPropertyStringChange', 'SVEWordBoundary',
    'eWORDTYPE_DELETED', 'DISPID_SpeechWaveFormatEx',
    'SPEI_RESERVED2', 'SpeechFormatType', 'DISPID_SRCResume',
    'SPPS_Noun', 'SPEI_TTS_AUDIO_LEVEL', 'SpeechVoiceEvents',
    'SpeechDisplayAttributes', 'SAFTCCITT_ALaw_8kHzStereo',
    'SPEI_START_SR_STREAM', 'DISPID_SVSInputWordLength',
    'SPEI_MIN_TTS', 'DISPID_SPPChildren', 'DISPID_SRCEPhraseStart',
    'SPBINARYGRAMMAR', 'SRATopLevel', 'SPXRO_SML',
    'SpeechTokenKeyFiles', 'SREInterference', 'DISPID_SGRsItem',
    'SAFT22kHz8BitStereo', 'SVP_0', 'DISPID_SRSNumberOfActiveRules',
    'SPWORD', 'DISPID_SRCEBookmark', 'SPCS_DISABLED', 'ISpPhrase',
    'SVSFUnusedFlags', 'DISPID_SpeechPhraseRule', 'SGRSTTTextBuffer',
    'SAFT12kHz16BitStereo', 'SAFTGSM610_8kHzMono',
    'ISpeechMMSysAudio', 'SSSPTRelativeToEnd', 'SpeechRuleAttributes',
    'DISPID_SpeechLexiconProns', 'DISPID_SABIEventBias',
    'DISPID_SASState', 'ISpeechPhraseRule', 'DISPID_SDKEnumValues',
    'DISPID_SPIStartTime', 'DISPID_SRAudioInput', 'DISPID_SVPriority',
    'SRSEIsSpeaking', 'SPRST_ACTIVE_ALWAYS', 'SRCS_Enabled',
    'DISPID_SPRulesItem', 'DISPID_SRCEAdaptation',
    'DISPID_SRCEStartStream', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SGRSTText', 'DISPID_SVSyncronousSpeakTimeout',
    'SpSharedRecoContext', 'STCInprocServer', 'SPPHRASE',
    'DISPID_SVSPhonemeId', 'SpeechPartOfSpeech', 'SPPS_Modifier',
    'ISpeechVoice', 'SpeechTokenKeyAttributes',
    'DISPID_SDKGetlongValue', 'eLEXTYPE_USER_SHORTCUT',
    'SVESentenceBoundary', 'IEnumString', 'SpeechEngineConfidence',
    'SECLowConfidence', 'SPDKL_LocalMachine', 'SPWAVEFORMATTYPE',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SAFGuid', 'DISPID_SVEWord',
    'ISpeechPhraseAlternate', 'DISPID_SpeechDataKey',
    'SpeechRecognizerState', 'eLEXTYPE_VENDORLEXICON',
    'SpeechTokenIdUserLexicon', 'DISPID_SPEPronunciation',
    'DISPID_SRGSetTextSelection', 'DISPID_SRRecognizer',
    'DISPID_SPRuleFirstElement', 'SpeechDiscardType',
    'DISPID_SVGetAudioInputs', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRProfile', 'ISpeechRecoContext', 'SGPronounciation',
    'DISPID_SPRuleId', 'SPRST_ACTIVE', 'SAFTADPCM_11kHzMono',
    'DISPID_SpeechVoiceEvent', 'SVSFParseMask', 'SpNotifyTranslator',
    'eLEXTYPE_PRIVATE2', 'SpeechPropertyNormalConfidenceThreshold',
    'ISpeechRecoResult2', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SOTGetStorageFileName', 'SPWF_INPUT', 'SDTRule',
    'DISPID_SRRGetXMLResult', 'SVSFParseAutodetect',
    'DISPID_SGRsCommit', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPIDSPTSI_SelectionLength', 'SPSERIALIZEDRESULT', 'SLTApp',
    'DISPID_SRCVoicePurgeEvent', 'SVEStartInputStream',
    'SPPS_RESERVED2', 'SPRS_INACTIVE', 'SREAdaptation',
    'DISPID_SpeechObjectTokens', 'DISPID_SLWType',
    'DISPID_SPIElements', 'SECFNoSpecialChars', 'ISpeechAudioFormat',
    'SRSActiveAlways', 'SPAUDIOOPTIONS', 'DISPID_SpeechLexiconWords',
    'DISPID_SpeechRecognizer', 'IInternetSecurityManager',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SLWs_NewEnum',
    'SpeechSpecialTransitionType', 'SITooSlow',
    'DISPID_SOTGetDescription', 'SAFT44kHz8BitMono', 'SRTAutopause',
    'SVSFPurgeBeforeSpeak', 'DISPID_SPIReplacements',
    'DISPID_SAVolume', 'DISPID_SpeechAudio', 'SAFT16kHz16BitMono',
    'DISPID_SVEventInterests', 'SWTDeleted', 'DISPID_SGRSTsItem',
    'STSF_FlagCreate', 'SWTAdded', 'DISPID_SPEsItem', 'ISpEventSink',
    'DISPID_SPCLangId', 'SGSDisabled', 'SVSFIsXML', 'SSTTDictation',
    'DISPID_SPILanguageId', 'DISPID_SPPName', 'SpeechUserTraining',
    'DISPID_SVAlertBoundary', 'DISPID_SPIGrammarId',
    'STCInprocHandler', 'SPAR_High', 'DISPID_SpeechXMLRecoResult',
    'SpeechCategoryVoices', 'SP_VISEME_1', 'ISpeechMemoryStream',
    'SDTAudio', 'SVP_2', 'SpeechDictationTopicSpelling',
    'SP_VISEME_19', 'DISPID_SGRName', 'DISPID_SPARecoResult',
    'SpeechAudioProperties', 'DISPID_SRGCmdLoadFromMemory',
    'eLEXTYPE_PRIVATE18', 'ISpeechLexiconWord', 'DISPID_SRCESoundEnd',
    'SITooFast', 'SPLO_STATIC', 'SPXMLRESULTOPTIONS',
    'SAFTADPCM_22kHzMono', 'DISPID_SRSAudioStatus',
    'ISpXMLRecoResult', 'SPPS_Unknown', 'DISPID_SPPConfidence',
    'SPTEXTSELECTIONINFO', 'DISPID_SDKSetStringValue',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SRCSetAdaptationData',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpLexicon',
    'ISpeechGrammarRuleStateTransitions', 'SPEI_SR_PRIVATE',
    'SP_VISEME_20', 'ISpeechLexiconPronunciations',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SpeechAudioStatus',
    'SPSMF_UPS', 'SINoise', 'DISPID_SDKEnumKeys',
    'DISPID_SRCERecognition', 'DISPID_SVSLastBookmarkId', 'SVP_18',
    'DISPID_SpeechVoiceStatus', 'SpeechVoiceSpeakFlags',
    'ISpRecognizer3', 'SREFalseRecognition', '_SPAUDIOSTATE',
    'SPEI_RESERVED3', 'SAFT24kHz8BitStereo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SMSGetData',
    'ISpStreamFormat', 'SPSLMA', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SVSFIsFilename', 'SPXRO_Alternates_SML', 'SVEAudioLevel',
    'DISPID_SVSInputWordPosition', 'DISPID_SpeechCustomStream',
    'SpeechWordPronounceable', 'DISPID_SGRSTsCount',
    'DISPID_SPRs_NewEnum', 'ISpeechObjectToken', 'SPSVerb',
    'ISpRecoContext', 'DISPID_SRGState', 'SRCS_Disabled',
    'DISPID_SOTId', 'ISpeechRecoResultTimes', 'DISPID_SLGetWords',
    'DISPID_SDKSetLongValue', 'DISPID_SPRFirstElement',
    'DISPID_SGRsCount', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SRRTLength', 'SRADynamic', 'DISPID_SpeechMMSysAudio',
    'DISPID_SPRuleChildren', 'eLEXTYPE_PRIVATE17', 'DISPID_SPPId',
    'DISPID_SASFreeBufferSpace', 'SPPS_LMA', 'DISPID_SRRRecoContext',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SpeechLexicon',
    'SGLexical', '_RemotableHandle', 'SAFTCCITT_ALaw_11kHzStereo',
    'eLEXTYPE_PRIVATE12', 'ISpPhoneticAlphabetSelection',
    'SECFIgnoreCase', 'SPVPRI_ALERT', 'ISpeechCustomStream',
    'SPWF_SRENGINE', 'DISPID_SMSALineId', 'SAFT22kHz16BitStereo',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPAUDIOBUFFERINFO',
    'SpSharedRecognizer', 'SDTAll', 'SVEEndInputStream',
    'DISPID_SVDisplayUI', 'DISPID_SRCERecognizerStateChange',
    'eWORDTYPE_ADDED', 'DISPID_SPRDisplayAttributes',
    'DISPID_SPPParent', 'DISPID_SpeechObjectTokenCategory',
    'SPCT_SUB_COMMAND', 'DISPID_SVSkip', 'SVP_9', 'ISpSerializeState',
    'SWPUnknownWordUnpronounceable', 'SPAO_RETAIN_AUDIO', 'SVP_7',
    ...
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SLWLangId',
    'DISPID_SRCAudioInInterferenceStatus', 'WAVEFORMATEX',
    'eLEXTYPE_RESERVED10', 'SREStreamStart', 'SSTTWildcard',
    'SGDSInactive', 'SPGS_DISABLED', 'SpeechAllElements',
    'SPSModifier', 'DISPID_SPEsCount',
    'DISPID_SVSInputSentencePosition', 'DISPID_SOTCategory',
    'DISPID_SLGetGenerationChange', 'SVP_13', 'SPRULESTATE',
    'DISPID_SDKDeleteValue', 'DISPID_SPELexicalForm',
    'SPEI_RESERVED6', 'SREPropertyStringChange',
    'DISPID_SpeechPhraseAlternate', 'SSSPTRelativeToCurrentPosition',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SRRPhraseInfo',
    'eLEXTYPE_RESERVED4', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'ISpeechLexiconWords', 'SP_VISEME_0', 'SPPS_Interjection',
    'SAFT48kHz8BitStereo', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SLPsCount', 'SVEPrivate', 'SPEI_TTS_PRIVATE',
    'SpeechPropertyResponseSpeed', 'SAFTDefault',
    'SAFTExtendedAudioFormat', 'DISPID_SpeechPhraseInfo',
    'SAFT8kHz16BitMono', 'SPEI_RECO_STATE_CHANGE',
    'SPEVENTSOURCEINFO', 'DISPID_SRRSetTextFeedback',
    'DISPID_SDKCreateKey', 'SDTAlternates',
    'SAFTCCITT_uLaw_11kHzStereo', 'tagSPTEXTSELECTIONINFO',
    'SAFT24kHz16BitStereo', 'SDA_Two_Trailing_Spaces',
    'ISpeechGrammarRuleState', 'SPSInterjection', 'SpeechRunState',
    'SpeechGrammarWordType', 'DISPID_SVEEnginePrivate',
    'SPINTERFERENCE', 'DISPID_SpeechPhraseReplacement', 'SGDisplay',
    'DISPID_SRCCreateResultFromMemory', 'ISpeechRecognizer',
    'DISPID_SPEAudioSizeTime', 'SAFT8kHz8BitMono',
    'SAFT11kHz8BitMono', 'DISPID_SGRSTPropertyId', 'DISPID_SLPLangId',
    'SPEI_SR_BOOKMARK', 'DISPID_SpeechPhraseProperties',
    'DISPID_SRRAudioFormat', 'SPAUDIOSTATE', 'eLEXTYPE_PRIVATE3',
    'SpeechRuleState', 'DISPID_SVESentenceBoundary',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpeechVisemeType', 'SVP_15',
    'SPBO_NONE', 'DISPID_SGRSTPropertyValue', 'SDTLexicalForm',
    'ISpEventSource', 'SVPOver', 'SVP_12', 'ISpeechObjectTokens',
    'SAFTADPCM_22kHzStereo', 'DISPID_SRState', 'SPEI_ADAPTATION',
    'DISPID_SVGetProfiles', 'SPEI_MAX_TTS', 'STSF_LocalAppData',
    'DISPID_SRCreateRecoContext', 'SASClosed', 'DISPID_SLPType',
    'DISPID_SGRsDynamic', 'DISPID_SVSCurrentStreamNumber',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SGRSAddRuleTransition',
    'SP_VISEME_21', 'SpResourceManager', 'eLEXTYPE_RESERVED6',
    'DISPID_SpeechRecoResult2', 'SPWT_LEXICAL', 'SpeechVoicePriority',
    'SPLO_DYNAMIC', 'SpStreamFormatConverter',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SRCBookmark', 'DISPID_SPAPhraseInfo',
    'DISPID_SVWaitUntilDone', 'DISPID_SVAudioOutputStream',
    'ISpeechGrammarRule', 'SP_VISEME_6', 'SECFDefault',
    'ISequentialStream', 'DISPID_SADefaultFormat',
    'SPPS_SuppressWord', 'SAFT16kHz8BitMono', 'SPBO_PAUSE',
    'SpeechTokenShellFolder', 'ISpeechVoiceStatus', 'SPPS_RESERVED1',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SASetState',
    'DISPID_SRCEFalseRecognition', 'DISPID_SVIsUISupported',
    'SPGRAMMARSTATE', 'eLEXTYPE_PRIVATE13', 'eLEXTYPE_PRIVATE15',
    'SpeechRegistryLocalMachineRoot', 'eLEXTYPE_USER',
    'SAFT11kHz16BitStereo', 'SpeechPropertyComplexResponseSpeed',
    'SGRSTTRule', 'SRAONone', 'DISPID_SRSClsidEngine',
    'DISPID_SOTs_NewEnum', 'DISPID_SOTCId',
    'SpeechGrammarTagWildcard', 'SAFT24kHz8BitMono',
    'SECFEmulateResult', 'DISPID_SVAudioOutput', 'SPGS_ENABLED',
    'SPEI_RECOGNITION', 'DISPID_SPEEngineConfidence',
    'DISPID_SLPs_NewEnum', 'DISPID_SPRText', 'SRESoundStart',
    'DISPID_SPIRule', 'DISPID_SMSSetData', 'DISPID_SVSRunningState',
    'DISPID_SRGetRecognizers', 'SPSHT_Unknown',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SASCurrentSeekPosition', 'SVP_10', 'SRAInterpreter',
    'SpeechVoiceCategoryTTSRate', 'SPEVENTENUM', 'SVP_20',
    'DISPID_SRGId', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SRGCmdSetRuleState', 'SAFT12kHz16BitMono',
    'DISPID_SGRsAdd', 'tagSPPROPERTYINFO', 'DISPID_SASNonBlockingIO',
    'SAFT12kHz8BitMono', 'ISpObjectWithToken', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SpeechVoice', 'DISPID_SPIEngineId', 'SAFT22kHz8BitMono',
    'DISPID_SGRClear', 'DISPID_SVRate', 'SPEI_PROPERTY_STRING_CHANGE',
    'SP_VISEME_10', 'SFTSREngine', 'DISPID_SOTRemove',
    'DISPID_SPERequiredConfidence', 'DISPID_SRSSupportedLanguages',
    'SP_VISEME_15', 'DISPID_SOTRemoveStorageFileName', 'SVF_None',
    'SVP_3', 'IInternetSecurityMgrSite', 'ISpRecoGrammar2',
    'SSFMOpenReadWrite', 'DISPID_SOTCreateInstance', 'SREAudioLevel',
    'SpCompressedLexicon', 'SP_VISEME_12', 'ISpeechAudioBufferInfo',
    'SDKLDefaultLocation', 'DISPID_SPRsItem', 'DISPID_SGRSTRule',
    'SpCustomStream', 'SpeechAudioFormatGUIDWave', 'SRARoot',
    'DISPID_SVPause', 'SGRSTTEpsilon', 'DISPID_SOTsCount',
    'SPEI_HYPOTHESIS', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SVVolume', 'SPEI_REQUEST_UI',
    'DISPID_SPPNumberOfElements', 'DISPID_SGRSTs_NewEnum', 'SVP_17',
    'SPEI_SENTENCE_BOUNDARY', 'SRTStandard', '__MIDL_IWinTypes_0009',
    'SPDKL_DefaultLocation', 'SRERequestUI',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SASCurrentDevicePosition', 'SRSInactive',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SDTProperty', 'SpMMAudioEnum',
    'SPSUnknown', 'DISPID_SRCRetainedAudio', 'SDKLLocalMachine',
    'SPAR_Medium', 'SpeechEmulationCompareFlags',
    'SAFT22kHz16BitMono', 'SPGRAMMARWORDTYPE', 'DISPID_SPAsCount',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SABIBufferSize',
    'DISPID_SGRSRule', 'DISPID_SOTGetAttribute', 'SBOPause',
    'SDKLCurrentUser', 'DISPID_SVResume', 'SpeechRecoContextState',
    'SPPS_Noncontent', 'SPSEMANTICFORMAT', 'SP_VISEME_8',
    'SREAllEvents', 'DISPID_SRCEventInterests',
    'DISPID_SRCESoundStart', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SPIGetText', 'DISPID_SLWsCount', 'SPVPRI_OVER',
    'SAFT48kHz8BitMono', 'SAFTCCITT_uLaw_44kHzStereo', 'SVP_19',
    'SREPhraseStart', 'SRSInactiveWithPurge', 'eLEXTYPE_RESERVED9',
    'ISpeechPhraseRules', 'DISPID_SABufferNotifySize',
    'SAFT32kHz16BitMono', 'SAFT48kHz16BitMono',
    'SAFTGSM610_22kHzMono', 'eLEXTYPE_PRIVATE7', 'ISpeechRecoGrammar',
    'DISPID_SPPs_NewEnum', 'DISPID_SGRAddResource',
    'ISpeechPhraseReplacements', 'DISPID_SWFESamplesPerSec',
    'SPADAPTATIONRELEVANCE', 'SVP_4', 'DISPID_SOTCSetId',
    'DISPID_SGRId', 'DISPID_SVEVoiceChange', 'DISPID_SVEAudioLevel',
    'DISPID_SRGetPropertyString', 'SPSHT_EMAIL',
    'DISPID_SpeechRecognizerStatus', 'SpWaveFormatEx',
    'SDTReplacement', 'SPEI_SOUND_END', 'IStream', 'STCRemoteServer',
    'DISPID_SRGSetWordSequenceData', 'SAFTCCITT_uLaw_22kHzMono',
    'ISpeechLexicon', 'SpeechRecoProfileProperties',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SGRAddState',
    'SPSNotOverriden', 'SVP_16', 'ISpeechResourceLoader',
    'SPFILEMODE', 'DISPID_SRStatus', 'DISPID_SGRsFindRule',
    'DISPID_SPPFirstElement', 'SPVPRIORITY',
    'DISPID_SVSpeakCompleteEvent', 'SAFTADPCM_44kHzMono',
    'DISPID_SPEAudioTimeOffset', 'SP_VISEME_14', 'STSF_CommonAppData',
    'SpeechTokenContext', 'SPAUDIOSTATUS',
    'ISpeechLexiconPronunciation', 'DISPID_SRCCreateGrammar',
    'DISPID_SAStatus', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SOTSetId', 'SREBookmark', 'DISPID_SRCRetainedAudioFormat',
    'SpeechVoiceSkipTypeSentence', '_ISpeechVoiceEvents',
    '_ISpeechRecoContextEvents', 'SVP_14',
    'DISPID_SABIMinNotification', 'SpMemoryStream', 'SPRS_ACTIVE',
    'SPEI_TTS_BOOKMARK', 'ISpObjectTokenCategory',
    'DISPID_SOTDisplayUI', 'SPCT_COMMAND', 'STCAll', 'DISPIDSPRG',
    'DISPID_SPIProperties', 'SVSFDefault', 'SVSFlagsAsync',
    'DISPID_SAFType', 'DISPID_SRCEInterference', 'SPEI_VISEME',
    'SPEVENT', 'DISPID_SPPValue', 'SAFT32kHz8BitMono', 'SITooLoud',
    'SPSERIALIZEDPHRASE', 'UINT_PTR', 'SAFT8kHz8BitStereo',
    'SPSEMANTICERRORINFO', 'SECNormalConfidence',
    'DISPID_SRRTStreamTime', 'SAFT11kHz16BitMono', 'SINoSignal',
    'SPPS_NotOverriden', 'DISPIDSPTSI_SelectionOffset',
    'SpeechGrammarTagDictation', 'SpeechCategoryAppLexicons',
    'ISpRecoGrammar', 'DISPID_SPCPhoneToId', 'SPSHT_OTHER',
    'DISPID_SRGRules', 'DISPID_SRCEAudioLevel', 'DISPIDSPTSI',
    'ISpeechPhraseReplacement', 'ISpRecoContext2', 'DISPID_SLWsItem',
    'DISPID_SDKGetStringValue', 'SpObjectToken',
    'SAFTGSM610_44kHzMono', 'SpFileStream', 'SpeechEngineProperties',
    'SGRSTTWord', 'SPRECOGNIZERSTATUS', 'SpeechGrammarState',
    'DISPID_SVSLastStreamNumberQueued', 'STCLocalServer',
    'eLEXTYPE_PRIVATE5', 'SpeechCategoryAudioOut', 'DISPID_SRRAudio',
    'SREPropertyNumChange', 'SP_VISEME_5', 'DISPID_SpeechObjectToken',
    'SREStreamEnd', 'SPEI_END_INPUT_STREAM', 'SPCS_ENABLED',
    'SpeechCategoryAudioIn', 'SGSExclusive', 'ISpeechPhraseProperty',
    'SBONone', 'SP_VISEME_2', 'SPSFunction', 'DISPID_SPACommit',
    'DISPID_SRCEEnginePrivate', 'SPAS_RUN', 'ISpRecognizer',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPVOICESTATUS', 'DISPID_SVEViseme',
    'SPRECOCONTEXTSTATUS', 'SPEI_WORD_BOUNDARY', 'DISPID_SOTCDefault',
    'ISpMMSysAudio', 'SpeechCategoryRecognizers',
    'DISPID_SVGetAudioOutputs', 'SpInProcRecoContext',
    'SRERecognition', 'eLEXTYPE_RESERVED8',
    'DISPID_SPEAudioStreamOffset', 'SAFT44kHz8BitStereo',
    'DISPID_SPRsCount', 'DISPID_SDKDeleteKey', 'DISPID_SVSpeakStream',
    'SPEI_SOUND_START', 'SVPNormal', 'ISpeechBaseStream',
    'ISpeechPhraseElements', 'SVP_8', 'SREStateChange',
    'SAFTADPCM_44kHzStereo', 'ISpeechRecognizerStatus',
    'SVSFVoiceMask', 'DISPID_SAFGetWaveFormatEx',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SVSpeak',
    'SPSHORTCUTPAIRLIST', 'DISPID_SDKGetBinaryValue',
    'SGDSActiveUserDelimited', 'ISpeechRecoResultDispatch',
    'SAFTADPCM_8kHzStereo', 'SPINTERFERENCE_TOOLOUD',
    'ISpeechAudioStatus', 'SSFMCreateForWrite', 'SPRST_NUM_STATES',
    'DISPID_SRRSaveToMemory', 'SPCT_SLEEP', 'SPSNoun',
    'DISPID_SRGCmdLoadFromResource', 'SRAImport',
    'DISPID_SpeechFileStream', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SVEBookmark', 'SpNullPhoneConverter',
    'DISPID_SGRSTPropertyName', 'SPCONTEXTSTATE',
    'DISPID_SRSetPropertyNumber', 'SVP_6',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SVEPhoneme',
    'SPVISEMES', 'DISPID_SRGCmdLoadFromObject', 'SAFT16kHz8BitStereo',
    'SPFM_CREATE', 'DISPID_SOTsItem', 'SpeechAudioState',
    'DISPID_SREmulateRecognition', 'ISpeechObjectTokenCategory',
    'DISPID_SRGDictationLoad', 'SVEViseme', 'ISpeechDataKey',
    'SPEI_RECO_OTHER_CONTEXT', 'SPSTREAMFORMATTYPE',
    'Speech_StreamPos_RealTime', 'DISPID_SPEDisplayAttributes',
    'SAFTNonStandardFormat', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SPIEnginePrivateData', 'SPLOADOPTIONS',
    'SPINTERFERENCE_NONE', 'DISPID_SPIAudioSizeTime',
    'DISPID_SBSSeek', 'DISPID_SRIsUISupported',
    'DISPID_SLGetPronunciations', 'DISPID_SRGReset', 'SFTInput',
    'SECHighConfidence', 'DISPID_SpeechLexiconWord',
    'SWPKnownWordPronounceable', 'SPINTERFERENCE_NOISE',
    'SpeechDataKeyLocation', 'SVSFPersistXML', 'SREHypothesis',
    'SpeechTokenKeyUI', 'SVSFNLPMask', 'SGLexicalNoSpecialChars',
    'SVP_11', 'eLEXTYPE_PRIVATE16', 'SpeechPropertyAdaptationOn',
    'DISPID_SpeechPhraseElements', 'DISPID_SRCEHypothesis',
    'DISPID_SPPEngineConfidence', 'SAFTCCITT_ALaw_11kHzMono',
    'SAFT32kHz8BitStereo', 'DISPID_SLPPartOfSpeech', 'ISpeechAudio',
    'DISPID_SRGetPropertyNumber', 'SAFT32kHz16BitStereo',
    'SECFIgnoreWidth',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpeechRecoResult', 'SPEI_PHONEME',
    'ISpeechTextSelectionInformation', 'ISpeechPhraseAlternates',
    'DISPID_SPPsCount', 'SPAO_NONE',
    'DISPID_SpeechLexiconPronunciation',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpRecognizer2', 'SGRSTTDictation', 'ISpShortcut',
    'SPRST_INACTIVE', 'Speech_Default_Weight',
    'SPWORDPRONUNCIATIONLIST', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SRCEEndStream', 'SVSFNLPSpeakPunc', 'SPEI_END_SR_STREAM',
    'ISpeechXMLRecoResult', 'SVSFParseSapi', 'SRERecoOtherContext',
    'SPBO_TIME_UNITS', 'DISPID_SAEventHandle', 'SPDKL_CurrentUser',
    'DISPID_SVSLastBookmark', 'ISpStreamFormatConverter',
    'SpeechBookmarkOptions', 'SpAudioFormat', 'SDKLCurrentConfig',
    'ISpeechGrammarRules', 'SVEVoiceChange', 'SAFTGSM610_11kHzMono',
    'DISPID_SGRsCommitAndSave', 'DISPID_SLWPronunciations',
    'SDTDisplayText', 'SPEI_START_INPUT_STREAM', 'DISPID_SVSVisemeId',
    'DISPID_SVSLastResult', 'SpeechStreamSeekPositionType',
    'SpeechRegistryUserRoot', 'SpeechLexiconType', 'SpLexicon',
    'SASRun', 'ISpResourceManager', 'SPEI_PROPERTY_NUM_CHANGE',
    'SpeechGrammarRuleStateTransitionType', 'Speech_StreamPos_Asap',
    'SPPARTOFSPEECH', 'SRADefaultToActive', 'SPEI_VOICE_CHANGE',
    'SAFTADPCM_8kHzMono', 'eLEXTYPE_PRIVATE19', 'SPSSuppressWord',
    'DISPID_SGRSTransitions', 'SpStream', 'ISpeechFileStream',
    'SpeechPropertyHighConfidenceThreshold',
    'SpeechCategoryRecoProfiles', 'SPEI_RESERVED1',
    'DISPID_SLRemovePronunciation',
    'DISPID_SpeechGrammarRuleStateTransition', 'ISpStream',
    'DISPID_SPAs_NewEnum', 'SRTEmulated', 'DISPID_SCSBaseStream',
    'SRTReSent', 'DISPID_SpeechPhraseRules', 'SPEI_PHRASE_START',
    'SPFM_NUM_MODES', 'SpeechWordType', 'SpObjectTokenCategory',
    'STSF_AppData', 'DISPID_SLGenerationId',
    'SPINTERFERENCE_TOOQUIET', 'SECFIgnoreKanaType',
    'DISPID_SLPSymbolic', 'SP_VISEME_11', 'DISPID_SVGetVoices',
    'SPCT_SUB_DICTATION', 'SPSHT_NotOverriden', 'SVEBookmark',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpeechWaveFormatEx',
    'SPEI_UNDEFINED', 'DISPID_SBSRead', 'SpUnCompressedLexicon',
    'SPRULE', 'SPINTERFERENCE_NOSIGNAL', 'DISPID_SGRSTWeight',
    'DISPID_SVEStreamEnd', 'ISpRecoResult', 'SPAS_STOP',
    'SRTSMLTimeout', 'SRAORetainAudio', 'DISPID_SFSClose',
    'DISPID_SGRs_NewEnum', 'DISPID_SLPPhoneIds',
    'ISpeechPhraseInfoBuilder', 'ISpPhraseAlt', 'SRTExtendableParse',
    'ISpVoice', 'SDA_Consume_Leading_Spaces',
    'Speech_Max_Pron_Length', 'DISPID_SRCVoice',
    'DISPID_SRGRecoContext', 'DISPID_SFSOpen', 'SAFT48kHz16BitStereo',
    'SSFMOpenForRead', 'SPRECOSTATE', 'SPWORDTYPE', 'SP_VISEME_13',
    'DISPID_SDKOpenKey', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SGRAttributes', 'SpeechRetainedAudioOptions',
    'SAFT8kHz16BitStereo', 'SPCT_DICTATION', 'SPAR_Unknown',
    'SPAR_Low', 'SpPhoneticAlphabetConverter',
    'DISPID_SRGIsPronounceable', 'SAFTText',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SWFEBlockAlign',
    'DISPID_SBSFormat', 'DISPID_SOTMatchesAttributes', 'SVPAlert',
    'DISPID_SpeechMemoryStream', 'SPFM_OPEN_READWRITE',
    'DISPID_SLAddPronunciation', 'SPDKL_CurrentConfig',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SpeechPhraseProperty',
    'DISPID_SRSetPropertyString', 'SAFTADPCM_11kHzStereo',
    'SPINTERFERENCE_LATENCY_WARNING', 'SRAExport',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SSFMCreate',
    'DISPID_SVEPhoneme', 'DISPID_SRGCmdSetRuleIdState',
    'ISpProperties', 'SVF_Emphasis', 'DISPID_SRRSpeakAudio',
    'DISPID_SLWWord', 'DISPID_SpeechGrammarRules',
    'eLEXTYPE_PRIVATE8', 'SPPROPERTYINFO', 'SAFTCCITT_uLaw_11kHzMono',
    'SAFTNoAssignedFormat', 'tagSTATSTG', 'SRSActive',
    'SPPHRASEELEMENT', 'SPGS_EXCLUSIVE', 'SpPhraseInfoBuilder',
    'SP_VISEME_9', 'SpeechRecognitionType', 'ISpeechPhraseElement',
    'SpeechTokenValueCLSID', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'ISpRecoCategory', 'SINone', 'eLEXTYPE_RESERVED7',
    'DISPID_SWFEExtraData', 'SPEI_MIN_SR', 'SAFTCCITT_uLaw_8kHzMono',
    'ISpGrammarBuilder', 'DISPID_SVStatus', 'SpeechVisemeFeature',
    'eLEXTYPE_PRIVATE11', 'SVP_1', 'SPRS_ACTIVE_USER_DELIMITED',
    'SLOStatic', 'DISPID_SRGCommit', 'SPLEXICONTYPE',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SWFEFormatTag',
    'ISpeechGrammarRuleStateTransition', 'SAFTCCITT_ALaw_8kHzMono',
    'SVEAllEvents', 'SpInprocRecognizer', 'SVSFIsNotXML',
    'SpeechMicTraining', 'DISPID_SpeechRecoResult',
    'SWPUnknownWordPronounceable', 'DISPID_SRRTimes',
    'DISPID_SpeechPhoneConverter', 'DISPID_SLPsItem',
    'eLEXTYPE_PRIVATE4', 'SP_VISEME_4', 'DISPID_SPCIdToPhone',
    'SpeechStreamFileMode', 'DISPID_SVVoice',
    'SpeechPropertyResourceUsage', 'SVF_Stressed',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SBSWrite',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SpeechBaseStream',
    'SREPrivate', 'DISPID_SOTIsUISupported', 'SASPause',
    'DISPID_SRCPause', 'SP_VISEME_7', 'SpShortcut',
    'DISPID_SRCRecognizer', 'DISPID_SpeechPhraseElement',
    'DISPID_SPRules_NewEnum', 'SpeechInterference',
    'DISPID_SRCERequestUI', 'DISPID_SPIAudioStreamPosition',
    'ISpeechPhraseInfo', 'DISPID_SpeechRecoContext',
    'DISPID_SpeechGrammarRule', 'SpTextSelectionInformation',
    'SpeechAddRemoveWord', 'SPWT_DISPLAY', 'SP_VISEME_16',
    'DISPID_SPIGetDisplayAttributes', 'SASStop', 'SpPhoneConverter',
    'SDA_One_Trailing_Space', 'DISPID_SPEs_NewEnum',
    'DISPID_SRDisplayUI', 'DISPID_SRCRequestedUIType', 'SP_VISEME_18',
    'DISPID_SPEDisplayText', 'SpMMAudioOut', 'SPFM_CREATE_ALWAYS',
    'ISpeechPhraseProperties', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SPAStartElementInResult', 'SpeechLoadOption',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SPPsItem',
    'SPPHRASERULE', 'ISpeechPhoneConverter', 'DISPID_SPAsItem',
    'SPFM_OPEN_READONLY', 'SPPS_Function', 'SPWORDPRONUNCIATION',
    'SGDSActive', 'eLEXTYPE_PRIVATE14', 'eLEXTYPE_PRIVATE20',
    'SPWT_PRONUNCIATION', 'SPEI_RESERVED5', 'SGDSActiveWithAutoPause',
    'eLEXTYPE_APP', 'SPDATAKEYLOCATION', 'ISpNotifySink',
    'SGSEnabled', 'DISPID_SGRSTNextState', 'DISPID_SRRTTickCount',
    'SSTTTextBuffer', 'LONG_PTR', 'DISPID_SRIsShared', 'SLODynamic',
    'Speech_Max_Word_Length', 'SpeechAudioVolume', 'SITooQuiet',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SRGDictationSetState', 'SAFT24kHz16BitMono',
    'SpeechAudioFormatType', 'SpVoice', 'SPBOOKMARKOPTIONS',
    'ISpAudio', 'DISPID_SPANumberOfElementsInResult', 'SPAS_CLOSED',
    'SPPHRASEPROPERTY', 'DISPID_SVSInputSentenceLength',
    'DISPID_SRAudioInputStream', 'DISPID_SPISaveToMemory', 'SVP_21',
    'SPPS_RESERVED3', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SpeechAudioFormat', 'eLEXTYPE_PRIVATE1',
    'DISPID_SOTCGetDataKey', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SPRuleConfidence', 'DISPID_SRSCurrentStreamPosition',
    'SPBO_AHEAD', 'SPWORDPRONOUNCEABLE', 'DISPID_SRCState',
    'DISPID_SWFEBitsPerSample', 'DISPID_SGRInitialState',
    'DISPID_SRGetFormat', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SpeechCategoryPhoneConverters', 'SPEI_INTERFERENCE',
    'DISPID_SOTDataKey', 'SPPS_Verb', 'DISPID_SPEActualConfidence',
    ...
    'DISPID_SGRSTType', 'SPSHORTCUTPAIR', 'SDA_No_Trailing_Space',
    'SVP_5', 'SPEI_MAX_SR', 'DISPID_SABufferInfo', 'ISpDataKey',
    'SpeechRecoEvents', 'SPAS_PAUSE', 'SPVPRI_NORMAL',
    'eLEXTYPE_PRIVATE10', 'DISPID_SWFEChannels', 'SVSFParseSsml',
    'SPRECORESULTTIMES', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SVEStreamStart', 'DISPID_SPRuleParent',
    'DISPID_SPRuleName', 'SAFT12kHz8BitStereo',
    'DISPID_SOTCEnumerateTokens', 'SPWORDLIST', 'SPPHRASEREPLACEMENT',
    'SAFT44kHz16BitMono', 'SpeechAudioFormatGUIDText',
    'ISpPhoneConverter', 'SPSHORTCUTTYPE', 'SLTUser',
    'SAFT44kHz16BitStereo', 'eLEXTYPE_PRIVATE6', 'DISPID_SMSADeviceId'
]

_check_version('1.1.14', 1653970961.954260)
